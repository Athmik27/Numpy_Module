...
print(random_number_generator.choice([10, 20, 30]))
...
random_number_generator.shuffle(array) # andomly changes the order of the elements inside the original array.
